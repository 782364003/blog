...
public class TokenUtil {
    ...
    private static final String TOKEN_SECRET = "token2002Sen";  //密钥盐
    public static final String TOKEN_HEADER = "Sen-Token";  //密钥盐
    ...
    public static boolean verify(String token) {
        try {
            JWTVerifier verifier = JWT.require(Algorithm.HMAC256(TOKEN_SECRET)).withIssuer("sen").build();
