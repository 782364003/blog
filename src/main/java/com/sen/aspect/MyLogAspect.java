...
public class MyLogAspect {
     ...
     * 切点表达式:   execution(...)
     */
    @Before("execution(public * com.sen.controller..*(..)) && @annotation(myLog)")
    public void doBefore(JoinPoint joinPoint,MyLog myLog) {
        ...
        requestLogService.save(RequestLog.builder().url(url).ipAddress(ipAddress).classMethod(classMethod).args(argsStr).build());
    }
