...
import com.sen.entity.other.OAuthTypeEnum;
import com.sen.service.UserService;
import com.sen.util.FileUploadUtils;
import com.sen.util.HttpUtils;
...
public class OAuth2LoginController {
    ...
    public String githubLogin(@RequestParam("code") String code) {
        try {
            ...
            final User realUser = userService.generateUserByGithubUsId(saveUser.getOauthUsId(), saveUser);
            final String senToken = TokenUtil.sign(realUser);
            return "redirect:" + vueHost + "&senToken=" + senToken;
        } catch (Exception e) {
