...
public class BlogController {
    ...
    public JsonResult getById(@PathVariable("idNum") Long blId) {
        Blog blog = blogService.findBlogWithTagsIdsById(blId);
    ...
    public JsonResult getBlogHasCommentDictionaries() {
        List<Object> blIds = commentService.listObjs(new LambdaQueryWrapper<Comment>().select(Comment::getBlId)).stream().distinct().collect(Collectors.toList());
